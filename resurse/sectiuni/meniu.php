...
<nav class="navbar navbar-expand-md navbar-light fixed-top bg-white">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark" href="mersul-trenurilor.php">Mersul trenurilor</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-dark" href="anulari.php">Anulări</a>
            </li>
            <li class="nav-item">
        ...
        <?php if (!isset($_SESSION['id'])) : ?>
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link text-dark" href="inregistrare.php">Înregistrare sau Logare</a>
                </li>
            </ul>
        <?php endif; ?>
        ...
        <?php if (isset($_SESSION['id'])) : ?>
            <ul class="navbar-nav ml-auto">
                ...
                <?php if ($_SESSION['tip_utilizator'] == "normal") : ?>
                    <li>
