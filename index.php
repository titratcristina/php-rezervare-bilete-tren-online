...
<body>
  <header>
    <nav class="navbar navbar-expand-md navbar-light fixed-top bg-white">
      <a class="navbar-brand" href="#">Festina lente</a>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#">Mersul trenurilor</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">Anulări/Întârzieri</a>
          </li>
          <li class="nav-item">
  ...
  <main role="main">
    ...
    <div class="container marketing mt-5 pt-5">
      ...
      <div class="row">
        ...
        <div class="col-12 text-left mt-5">
          ...
          <img class="img-fluid" src="img/diagrama-site.svg" alt="diagrama-uml">
          ...
          <ul>
            ...
            <ul>
              ...
              <li>Selectarea locurilor se va face folosind imaginea svg de mai jos: <br>
                <img class="img-fluid my-3" src="img/tren-interior.svg" alt="tren-interior">
              </li>
            </ul>
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5">
         <img class="img-fluid" src="img/diagrama-bd.svg" alt="diagrama-bd">
        </div>
      </div>
      ...
      <div class="row featurette">
        ...
        <div class="col-md-7 order-md-1">
         <img class="img-fluid" src="img/inspo.png" alt="website">
        </div>
      </div>
    ...
    <footer class="container">
      ...
      <!-- <p>&copy; 2017-2020 . &middot; <a href="#">Legal</a> &middot; <a href="#">Termeni și condiții</a></p> -->
    </footer>
  </main>
