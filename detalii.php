	...
	<main role="main">
		...
		<div class="container marketing mt-5 pt-5">
			<div class="row">
				...
				<div class="col-lg-4">
					<svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-emoji-neutral mb-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
				...
				<div class="col-lg-4">
					<svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-emoji-smile mb-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
						<path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
				...
				<div class="col-lg-4">
					<svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-emoji-sunglasses mb-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
						<path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
